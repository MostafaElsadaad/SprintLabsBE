...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260830213609_TeacherClassAssignments")]
    partial class TeacherClassAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Grade", b =>
                {
                    ...
                    b.HasIndex("CommunityId", "Value")
                        .IsUnique();

                    b.ToTable("Grades", t =>
                        {
                            t.HasCheckConstraint("CK_Grades_Value_Supported", "`Value` IS NULL OR `Value` IN (7, 8, 9, 10, 11, 12)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.Match", b =>
                {
                    ...
                    b.Property<string>("MirrorRoomId")
                        .HasMaxLength(128)
            ...
            modelBuilder.Entity("Domain.Models.MatchPlayer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("AnswerTimeTotalMs")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("QuestionTimeTotalMs")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Models.MatchQuestionResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("StreakBeforeAnswer")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MatchQuestionResults");
                });

            modelBuilder.Entity("Domain.Models.MatchRewardResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("MatchResultXp")
                        .HasColumnType("int");

                    b.Property<int>("MissionXp")
                        .HasColumnType("int");

                    b.Property<int>("NewLevel")
                        .HasColumnType("int");

                    b.Property<int>("NewRankTier")
                        .HasColumnType("int");

                    b.Property<int>("NewRp")
                        .HasColumnType("int");

                    b.Property<int>("NewTotalXp")
                        .HasColumnType("int");

                    b.Property<int>("OldLevel")
                        .HasColumnType("int");

                    b.Property<int>("OldRankTier")
                        .HasColumnType("int");

                    b.Property<int>("OldRp")
                        .HasColumnType("int");

                    b.Property<int>("OldTotalXp")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Player", b =>
                {
                    ...
                    b.Property<int>("HighestRankTier")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Domain.Models.PlayerRankLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PlayerRankLogs");
                });

            modelBuilder.Entity("Domain.Models.PlayerXpLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Models.StudentLicense", b =>
                {
                    ...
                    b.HasIndex("CommunityId", "ClassId");

                    b.HasIndex("CommunityId", "GradeId");

                    b.HasIndex("CommunityId", "Status");

                    b.HasIndex("CommunityId", "Email", "Status");
            ...
            modelBuilder.Entity("Domain.Models.MatchPlayer", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Player", "PlayerProfile")
                        .WithMany("MatchPlayers")
            ...
            modelBuilder.Entity("Domain.Models.Community", b =>
                {
                    ...
                    b.Navigation("MatchRewardResults");

                    b.Navigation("Matches");

                    b.Navigation("PlayerRankLogs");

                    b.Navigation("PlayerXpLogs");

                    b.Navigation("StudentLicenses");
                });
            ...
            modelBuilder.Entity("Domain.Models.Match", b =>
                {
                    ...
                    b.Navigation("MatchQuestionResults");
